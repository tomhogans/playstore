...
.method private addEventImpl(Landroid/os/Message;)V
    ...
    :try_end_47
    .catchall {:try_start_3a .. :try_end_47} :catchall_76
    .catch Ljava/io/IOException; {:try_start_3a .. :try_end_47} :catch_4b
    ...
    :try_end_72
    .catchall {:try_start_4c .. :try_end_72} :catchall_76
...
.method private uploadEventsImpl()V
    ...
    :try_end_19
    .catchall {:try_start_12 .. :try_end_19} :catchall_160
    ...
    invoke-static {v7, v8}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_4e
    .catchall {:try_start_3f .. :try_end_4e} :catchall_160
    ...
    invoke-static {v7, v8}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_c8
    .catchall {:try_start_74 .. :try_end_c8} :catchall_160
    ...
    :try_end_e2
    .catchall {:try_start_c8 .. :try_end_e2} :catchall_15b
    ...
    invoke-static {v7, v8, v1}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_100
    .catchall {:try_start_e4 .. :try_end_100} :catchall_15b
    ...
    :try_end_104
    .catchall {:try_start_101 .. :try_end_104} :catchall_160
    ...
    invoke-virtual {v7, v3, v0}, Lcom/google/android/play/analytics/RollingFileStream;->closeInputStream(Ljava/io/InputStream;Z)V
    :try_end_10b
    .catch Ljava/io/IOException; {:try_start_106 .. :try_end_10b} :catch_10d
    ...
    :try_end_12f
    .catchall {:try_start_12c .. :try_end_12f} :catchall_15b
    .catch Ljava/io/IOException; {:try_start_12c .. :try_end_12f} :catch_e3
    ...
    invoke-static {v4}, Lcom/google/android/play/analytics/ProtoCache;->recycleLogRequest(Lcom/google/android/play/analytics/ClientsAnalytics$LogRequest;)V
    :try_end_133
    .catchall {:try_start_130 .. :try_end_133} :catchall_160
    ...
    invoke-virtual {v7, v3, v0}, Lcom/google/android/play/analytics/RollingFileStream;->closeInputStream(Ljava/io/InputStream;Z)V
    :try_end_13a
    .catch Ljava/io/IOException; {:try_start_135 .. :try_end_13a} :catch_13c
    ...
    :try_end_168
    .catch Ljava/io/IOException; {:try_start_163 .. :try_end_168} :catch_169
...
.method protected uploadLog(Landroid/accounts/Account;Lcom/google/android/play/analytics/ClientsAnalytics$LogRequest;)Z
    ...
    const-string v10, "https://www.whatrunswhere.com/googleapi/play/log"
    ...
    :try_end_8e
    .catch Ljava/lang/NumberFormatException; {:try_start_57 .. :try_end_8e} :catch_8f
