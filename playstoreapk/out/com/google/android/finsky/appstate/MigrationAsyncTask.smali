...
.method private collectLegacyData(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    :try_end_1a
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_11 .. :try_end_1a} :catch_73
    ...
    :cond_60
    :goto_60
    packed-switch v13, :pswitch_data_aa
    ...
    :try_end_6d
    .catchall {:try_start_3e .. :try_end_6d} :catchall_6e
    ...
    invoke-interface {v0, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_a0
    .catchall {:try_start_87 .. :try_end_a0} :catchall_6e
